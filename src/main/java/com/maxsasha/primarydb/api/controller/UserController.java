package com.maxsasha.primarydb.api.controller;
...
import com.maxsasha.primarydb.api.dto.UserDto;
import static com.maxsasha.primarydb.api.transformer.UserTransformer.*;
import com.maxsasha.primarydb.entity.User;
import com.maxsasha.primarydb.service.UserService;
...
public class UserController {
    ...
    @GetMapping
    public Page<User> getUsers(@RequestParam(defaultValue = "${default.page}") Integer page,
